...
export default function Rodape(){
    return(
        <div className='rodape'>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#F2EED7" className="bi bi-r-circle" viewBox="0 0 16 16">
            ...
            <p className="rodape__texto">Desenvolvido por IFFAR JC</p>
        </div>
